...
function AdvocaderaserCard() {
    ...
    return (
        <ProjectCard layoutId="project-1">
            ...
            <p className={"text-sm"}>{t("projects.main.advoInfo")}</p>
...
function SignatuurCard() {
    ...
    return (
        <ProjectCard layoutId="project-2">
            ...
            <p className={"text-sm"}>{t("projects.main.signInfo")}</p>
            <div className={"flex-col flex gap-2"}>
...
function GamereviewsCard() {
    ...
    return (
        <ProjectCard layoutId="project-3">
            ...
            <p className={"text-sm"}>{t("projects.main.reviewInfo")}</p>
            <div className={"flex-col flex gap-2"}>
...
function TrippieCard() {
    ...
    return (
        <ProjectCard layoutId="project-6">
            ...
            <p className={"text-sm"}>{t("projects.main.trippieInfo")}</p>
            <div className={"flex-col flex gap-2"}>
...
function StagelinkCard() {
    ...
    return (
        <ProjectCard layoutId="project-7">
            ...
            <p className={"text-sm"}>{t("projects.main.stageInfo")}</p>
            <div className={"flex-col flex gap-2"}>
